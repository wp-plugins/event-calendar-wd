...
// var_dump($ecwd_event_day_monday, $ecwd_event_day_thursday,
// $ecwd_event_day_wendesday, $ecwd_event_day_thursday, $ecwd_event_day_friday, $ecwd_event_day_friday,
// $ecwd_event_day_saturday, $ecwd_event_day_sunday);
                ...
                <select name="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_venue"
                    ...
                    foreach ($venues as $venue) {
                        ...
                        <option value="<?php echo $venue->ID; ?>" data-location="<?php echo $venue_location; ?>"
                                data-marker="<?php echo $venue_lat_long; ?>" data-zoom="<?php echo $venue_zoom; ?>" <?php echo selected($venue->ID, $ecwd_event_venue); ?>><?php echo $venue->post_title; ?></option>
                    <?php
                    }
                    ?>
                </select>
...
<!--            <div id="--><?php //echo ECWD_PLUGIN_PREFIX; ?><!--_event_pickup_date" class="button" value="">Days</div>-->
<!--            <div id="--><?php //echo ECWD_PLUGIN_PREFIX; ?><!--_event_pickup_time" class="button" value="">Time</div>-->
            <div class="checkbox-div">
                        ...
                        <p>
                            <label>
                                <input checked='checked'
                                       ...
                                       class="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_event_radio" type="radio"
                    ...
                    <div id="ecwd_monthly" class="hidden">
                        <div>
                            ...
                            <input type='radio' value="1" <?php checked($ecwd_event_repeat_month_on_days, '1') ?>
                                   name="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_month_on_days" id="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_month_on_days_1"
                                   class="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_choose"/>
                            <label class="repeat_format_monthly" for="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_month_on_days_1"><?php _e('On the same day', 'ecwd'); ?></label>
<!--                            <input type="text" name="--><?php //echo ECWD_PLUGIN_PREFIX; ?><!--_event_repeat_on_the_m"-->
<!--                                   class='--><?php //echo ECWD_PLUGIN_PREFIX; ?><!--_event_repeat_on_the'-->
<!--                                   value="--><?php //echo $ecwd_event_repeat_on_the_m; ?><!--"/>-->
                        </div>

                        <div class="ecwd_event_repeat_event_div">

                            <input type='radio' value="2" <?php checked($ecwd_event_repeat_month_on_days, '2') ?>
                                   name="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_month_on_days" id="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_month_on_days_2"
                                   class="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_list_radio"/>

                            <label class="repeat_format_monthly" for="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_month_on_days_2"><?php _e('On the: ', 'ecwd'); ?></label>
                    ...
                    <div id="ecwd_yearly" class="hidden">
                        <select name="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_year_month"
                                id="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_year_month" disabled="disabled" class="select_to_enable_disable">
                        ...
                        <div class="ecwd_event_repeat_event_div">
                            <input type='radio' value="1" <?php checked($ecwd_event_repeat_year_on_days, '1') ?>
                                   name="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_year_on_days" id="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_year_on_days_1"
                                   class="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_choose"/>
                            <label class="repeat_format_monthly" for="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_year_on_days_1"><?php _e('On the same day', 'ecwd'); ?>:</label>
<!--                            <input type="text" name="--><?php //echo ECWD_PLUGIN_PREFIX; ?><!--_event_repeat_on_the_m"-->
<!--                                   class='--><?php //echo ECWD_PLUGIN_PREFIX; ?><!--_event_repeat_on_the'-->
<!--                                   value="--><?php //echo $ecwd_event_repeat_on_the_m; ?><!--"/>-->
                        </div>
                        ...
                        <div class="ecwd_event_repeat_event_div">
                            <input type='radio' value="2" <?php checked($ecwd_event_repeat_year_on_days, '2') ?>
                                   name="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_year_on_days" id="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_year_on_days_2"
                                   class="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_list_radio"/>

                            <label class="repeat_format_monthly" for="<?php echo ECWD_PLUGIN_PREFIX; ?>_event_repeat_year_on_days_2"><?php _e('On the: ', 'ecwd'); ?></label>
